import matplotlib
matplotlib.use("Agg")  # Evita congelar la ventana gráfica de Flet
...
class GraficadorBiomecanico:
    ...
    def generar_grafico_rendimiento(ruta_carpeta: str, nombre_atleta: str) -> str:
        """Genera y guarda una gráfica con las curvas de ángulo articular e índice de fatiga."""
